...
urlpatterns = [
    ...
    path('bank_details/upload/add',views.bankUploadViaFormAddAnother),
    ...
    path('integration/bulk/payment', views.integration_bulk_payment, name='integration-bulk-payment'),
